...
import makeAnimated from 'react-select/animated';
  ...
  let spacialADCat = [
    ...
    { value: 'Employment', label: 'Employment',id:2 },
    { value: 'Housing', label: 'Housing',id:3 },
    { value: 'Social Issues, elections or politics', label: 'Social Issues, elections or politics',id:4 },
  ];
  const animatedComponents = makeAnimated();
function CamapignAdd () {
  const [selectedOption, setSelectedOption] = useState(null);
  // console.log(selectedOption,"optons");
  return (
    <>
